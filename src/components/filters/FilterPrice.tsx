...
function FilterPrice() {
  ...
  const handleChange = useCallback((price: TPrice) => {
    setSelectedPrices(selectedPrices.price_gte === price.price_gte ? {} as TPrice : price);
    ...
    <div className="price-container">
      <p className="price-title">Faixa de preço</p>
        {priceRange.map(price => (
          ...
          <input id={price.key} type="checkbox" onChange={() => handleChange(price)} />
